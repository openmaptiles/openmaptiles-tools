...
readonly PGHOSTS_LIST=${PGHOSTS_LIST:-"postgres"} # "host=10.220.44.57&host=10.220.44.56&host=10.220.44.59"
readonly PGPORT=${PGPORT:-5432}
readonly HOST_COUNT=${HOST_COUNT:-3}  # number of postgres servers
readonly CPU=${CPU:-16}  # number of CPUs per postgres server
